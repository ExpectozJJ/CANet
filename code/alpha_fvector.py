...
class alpha_fvector:
    def __init__(self, points, min_edge_length = 0.0, max_edge_length = 1.0, max_dim = 0, num_instances = 100):
        self.points = points
...
#fmodel = alpha_fvector(points, min_edge_length = 0.01, max_edge_length = 10.0, max_dim = 1, num_instances = 100)
