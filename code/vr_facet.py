...
class vr_facet:
    def __init__(self, distance_matrix, max_dim = 0, min_edge_length = 0.01, max_edge_length = 1.0, num_samples=100):
    ...
    def vietoris_rips_simplices_birth_death(self):
        ...
        Parameters:
            distance_matrix (ndarray): An array of shape (n, n) with pairwise distances between any two points.
        ...
        # Build the Vietoris-Rips complex using Gudhi.
...
#model = vr_facet(points, max_dim = 2, min_edge_length = 0.01, max_edge_length = 10.0, num_samples=100)
