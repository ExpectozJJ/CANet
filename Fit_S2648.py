...
def SR_job(list_, folder1, folder2):
    ...
    for ilist in list_:
        ...
        fp.write(f'cd /mnt/scratch/weejunji/junjie-proteng/S2648/{dst}\n')
...
def run_SR(list_, folder1, folder2):
    ...
    for i in range(len(list_)):
        ...
        tmp = np.load(f'{dst}/{opp_folder_dir}_SR_curves.npy', allow_pickle=True)
        if np.shape(tmp)[0] != 1410:
...
if not os.path.exists("./S2648/SR_jobs/"):
    os.mkdir("./S2648/SR_jobs/")

if not os.path.exists("./S2648/SR_out/"):
    os.mkdir("./S2648/SR_out/")
