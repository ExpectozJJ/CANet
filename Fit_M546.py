...
def link_SR(PDBid, Chains, Chain, resWT, resID, resMT, pH):
    ...
    os.system("ln -s ../../../code/TopLapFit/code/feature_SR.py feature_SR.py")
    os.chdir("../../")
    return 

def SR_job(list_, folder1, folder2):
    numCPU = 10
    os.chdir("./M546/")
    for ilist in list_:
        ...
        fp.write(f'#SBATCH --output=./SR_out/{folder_dir}.out\n')
        fp.write(f'cd /mnt/research/guowei-search.4/junjie-proteng/M546/{dst}\n')
        ...
        fp.write('python feature_SR.py '+' '.join(ilist)+'\n')
        fp.close()
    os.chdir("../")
    return

def run_SR(list_, folder1, folder2):
    os.chdir("./M546/")
    for i in range(len(list_)):
        ...
        #if not os.path.exists(f'{dst}/{folder_dir}_SR_curves.npy') or not os.path.exists(f'{dst}/{folder_dir}_SR_rates.npy'):
...
def gen_PDBs(PDBid, Chains, Chain, resWT, resID, resMT, pH):
    print(PDBid, Chains, Chain, resWT, resID, resMT)
    #os.system("rm -rf features/{}_{}_{}_{}_{}".format(PDBid, Chain, resWT, resID, resMT))
    ...
    curr_dir = "features/{}_{}_{}_{}_{}/".format(PDBid, Chain, resWT, resID, resMT)
    os.chdir("features/{}_{}_{}_{}_{}".format(PDBid, Chain, resWT, resID, resMT))
    if PDBid == '4ZWJ' and (resID == '345' or resID == '347'):
        os.system(f'cp ../../af3/{PDBid.lower()}{Chain}.pdb {PDBid}.pdb')
        #os.system(f'cp ../../af3/{PDBid.lower()}{Chain}.fasta {PDBid}.fasta')
    os.system("ln -s ../../../code/TopLapFit/bin/jackal.dir jackal.dir")
    os.system("ln -s ../../../code/TopLapFit/bin/profix profix")
    os.system("ln -s ../../../code/TopLapFit/bin/scap scap")
    os.system("ln -s ../../../code/TopLapFit/code/structure.py structure.py")
    os.system("ln -s ../../../code/TopLapFit/code/protein.py protein.py")
    os.system("ln -s ../../../code/TopLapFit/code/feature.py feature.py")
    os.system("ln -s ../../../code/TopLapFit/code/feature_dssp.py feature_dssp.py")
    os.system("ln -s ../../../code/TopLapFit/code/feature_Lap.py feature_Lap.py")
    os.system("ln -s ../../../code/TopLapFit/code/feature_seq.py feature_seq.py")
    os.system("ln -s ../../../code/TopLapFit/code/prepare.py prepare.py")
    os.system("ln -s ../../../code/TopLapFit/code/src src")
...
if not os.path.exists("./M546/features/"):
    os.system("mkdir ./M546/features/")

#start, end = int(sys.argv[1]), int(sys.argv[2])

seq_list = dataset_list("./M546/M546.txt")
#print(seq_list)
#mp_gen_PDBs(seq_list)
#os.chdir("./M546/")
#for i in range(len(seq_list)):
    #PDBid, Chains, Chain, resWT, resID, resMT, pH = seq_list[i][0], seq_list[i][1], seq_list[i][2], seq_list[i][3], seq_list[i][4], seq_list[i][5], seq_list[i][6]
    #if PDBid == '4ZWJ' and (resID == '345' or resID == '347'):
        #print(PDBid, Chains, Chain, resWT, resID, resMT, pH)
        #gen_PDBs(PDBid, Chains, Chain, resWT, resID, resMT, pH)
#os.chdir("../")

if not os.path.exists("./M546/blast_jobs/"):
    os.mkdir("./M546/blast_jobs/")
if not os.path.exists("./M546/blast_out/"):
    os.mkdir("./M546/blast_out/")
...
if not os.path.exists("./M546/feat_jobs/"):
    os.mkdir("./M546/feat_jobs/")

if not os.path.exists("./M546/feat_out/"):
    os.mkdir("./M546/feat_out/")

#check_MIBPB(seq_list, "features")
feat_job(seq_list, "features", "feat_jobs")
#run_feat(seq_list, "features", "feat_jobs")

if not os.path.exists("./M546/seq_jobs/"):
    os.mkdir("./M546/seq_jobs/")

if not os.path.exists("./M546/seq_out/"):
    os.mkdir("./M546/seq_out/")

seq_job(seq_list, "features", "seq_jobs")
#run_seq(seq_list, "features", "seq_jobs")

if not os.path.exists("./M546/SR_jobs/"):
    os.mkdir("./M546/SR_jobs/")

if not os.path.exists("./M546/SR_out/"):
    os.mkdir("./M546/SR_out/")
...
#os.chdir("../")
SR_job(seq_list, "features", "SR_jobs")
run_SR(seq_list, "features", "SR_jobs")